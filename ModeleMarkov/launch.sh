...
then
	...
	type_improvisations=""
	nombre_notes="-1"
	fichier_historique="../InterfaceGraphique/launch_log/log.txt"
	...
	do
		...
		then
			...
			then
				...
				then
					echo -e "# Fichier $1 introuvable dans $dossier_partitions_defaut"
	...
	then
		...
		do
			...
			then
				...
				./lib/generateur_aleatoire_sous_contraintes/aleatoire -o $improvisation -c $modelisation -n 20 -g 50 > $redirection_sortie
